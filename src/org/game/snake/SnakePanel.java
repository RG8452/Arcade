...
public class SnakePanel extends JPanel
{
	...
	protected void paintComponent(Graphics g)
	{
		...
		g.drawString("SCORE: " + ((Snake) Arcade.curGame).score, (int) (leftX * 1.25), topY - 15);
		int seconds = (int) ((Snake) Arcade.curGame).seconds;
		DecimalFormat df = new DecimalFormat("00");
		g.drawString("TIME: " + df.format((int)(seconds/60)) + ":" + df.format((int)(seconds%60)), (int)(leftX*1.8), topY-15);
